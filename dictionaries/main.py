...
def check_passport(passport, destination_country, allowed_destinations_per_country, forbidden_origins_per_country):
    ...
    if destination_country in allowed_destinations_per_country[nationality]:
        if destination_country in forbidden_origins_per_country:
            if nationality in forbidden_origins_per_country:
                return False
...
if __name__ == '__main__':
    ...
    hank = check_passport(hank, 'The Netherlands', {'Belgium': ['The Netherlands']}, {'The Netherlands': ['North Korea']})
    print(hank)

    hank = add_stamp(hank, 'North Korea')
    print(hank)

    print(check_passport(hank, 'The Netherlands', {'Belgium': ['The Netherlands']}, {'The Netherlands': ['North Korea']}))
